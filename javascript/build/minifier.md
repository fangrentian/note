<!--
 * @author: ares
 * @date: 2022-01-14 10:46:51
 * @lastEditTime: 2022-01-14 10:48:18
 * @lastEditors: ares
 * @description: 
 * 
-->
...
let distDir = path.join(__dirname, './ares'); //压缩后的目录
let sourceDir = path.join(__dirname, './aresModules'); //项目源代码
